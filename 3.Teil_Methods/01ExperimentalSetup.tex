...
In this way, it was possible to measure and compare the accuracy of the reconstruction algorithms by comparing the reconstructed data to the known solution.%model which was used to generate the projection data.
