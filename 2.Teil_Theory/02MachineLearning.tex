...
\begin{figure}[h!]
    ...
    \caption{A surface plot of the space of error for a model. The trajectory shows the path of parameter optimisation based on gradient descent.
        Notice that the smooth curve is an indication of many steps with a small step size. An animation of the process is available at % Github hyperref. \url{ }
    }
...
\begin{figure}[h!]
    ...
    \caption{A surface plot of the space of error for a model.
        ...
        An animation of the process is available at % Github hyperref. \url{ }
    }
