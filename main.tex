...
\cleardoublepage
\include{FrontBackMatter/Zusammenfassung.tex}
...
%\ctparttext{\include{2.Teil Theory/00Introduction}}
...
\include{2.Teil_Theory/00Introduction} % Chapter 1
...
%\include{2.Teil Theory/01TheoryCT}
...
\include{2.Teil_Theory/01TheoryCT}
\include{2.Teil_Theory/02MachineLearning}
\include{2.Teil_Theory/03ScatteringTheory}
\include{2.Teil_Theory/04SAXSTT}
...
\include{3.Teil_Methods/01ExperimentalSetup}
\include{3.Teil_Methods/02Implementation}
\include{3.Teil_Methods/03Tests}
...
\include{4.Teil_Results/01Validation}
\include{4.Teil_Results/02Reconstructions}
\include{4.Teil_Results/03PerformanceReview}
...
\include{5.Teil_Discussion/01Validation}
\include{5.Teil_Discussion/02Comparisons}
%\include{5.Teil_Discussion/03PerformanceImprovements}

\cleardoublepage

\include{5.Teil_Discussion/04Conclusion_Future.tex}
...
%\include{6.Teil_Appendix/Chapter0A} % Appendix A
%\include{6.Teil_Appendix/Chapter0B} % Appendix B - empty template
