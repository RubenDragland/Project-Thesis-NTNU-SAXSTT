...
\include{2.Teil Theory/00Introduction} % Chapter 1
...
\include{2.Teil Theory/01TheoryCT}
\include{2.Teil Theory/02MachineLearning}
\include{2.Teil Theory/03SAXSTT}

\cleardoublepage % Empty page before the start of the next part


\part{Methods}
\include{3.Teil Methods/01Implementation}
\include{3.Teil Methods/Data Analysis}
