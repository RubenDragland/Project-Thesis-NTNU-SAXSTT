...
%\svgsetup{inkscapeexe={"C:\Program Files\Inkscape\bin\inkscape.exe"}, inkscapearea=drawing, inkscapeversion=1}
\svgpath{{Figures/}{./XRD_CT/Figures}{./XRD_CT/Plotting/}{./XRD_CT/Plotting/thesis_plots}}
\usepackage{siunitx}
...
\newcommand{\sinphiop}{\sin\varphi_{op}}
\newcommand{\cosphiop}{\cos\varphi_{op}}
\newcommand{\sinthetaop}{\sin\theta_{op}}
\newcommand{\costhetaop}{\cos\theta_{op}}
\newcommand{\reciprocalspacemap}{\bm{\widehat{\mathrm{R}}}(\bm{\mathrm{r'}}, \bm{\mathrm{q'}})}
% \newcommand{\vectorBU}[1]{\textbf{#1}}
\newcommand{\vectorBU}[1]{\bm{\mathrm{#1}}}
\newcommand{\vectorgreek}[1]{\mathrm{\boldsymbol{#1}}}

\newcommand{\In}{I_{n}(x,y, q, \phi )}
\newcommand{\Inhat}{\widehat{I}_{n}(x,y, q, \phi )}
...
\newcommand{\mySubtitle}{Optimisation of Small Angle X-ray Scattering Tensor Tomography by Automatic Differentiation during Conjugate Gradient Descent\xspace}
